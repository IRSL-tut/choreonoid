...
public:
    ...
    */
    ...
    /*
       Joint effort value. When a controller writes this value, it is the
       command effort sent to the actuator. When a simulator writes it back
       with drive effort output enabled, it is the effort actually generated by
       the actuator or drive model. It is not the net joint effort including
       gravity, contact, or external forces. Such net values should be exposed
       by a joint effort sensor when that device is introduced.
    */
