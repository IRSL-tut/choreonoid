#ifndef CNOID_BULLET_PLUGIN_BT_CONTINUOUS_TRACK_H
#define CNOID_BULLET_PLUGIN_BT_CONTINUOUS_TRACK_H
...
class BtContinuousTrack : public Device
{
public:
    BtContinuousTrack();
    BtContinuousTrack(const BtContinuousTrack& org, bool copyStateOnly = false);
    virtual const char* typeName() const override;
    void copyStateFrom(const BtContinuousTrack& other);
...
typedef ref_ptr<BtContinuousTrack> BtContinuousTrackPtr;
